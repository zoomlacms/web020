<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.WebSite.User.UserZone.Pic.PicTureList, App_Web_xllefpxs" enableEventValidation="false" viewStateEncryptionMode="Never" %>
