<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_LabelSql, App_Web_5hx3alnv" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
	...
	<table class="table table-striped table-bordered">
			...
			<asp:Repeater ID="repParam" runat="server" OnItemCommand="repParam_ItemCommand">
			  <ItemTemplate>
				<tr class="tdbg">
				  ...
				  <td align="center">&nbsp;
					<asp:LinkButton ID="LinkButton2" runat="server" CommandName="Edit" CommandArgument='<%# Eval("Param") %>'><i class="fa fa-pencil" title="修改" style="font-size:18px;"></i></asp:LinkButton>
					<asp:LinkButton ID="LinkButton1" runat="server" CommandName="Del" CommandArgument='<%# Eval("Param") %>'><i class="fa fa-trash" title="删除" style="font-size:18px;margin-left:10px;"></i></asp:LinkButton></td>
				</tr>
			  </ItemTemplate>
			</asp:Repeater>
            <tr>
	  ...
	  <tr class="tdbg">
		...
		<td><div id="gridviewclause" class="fielddiv">
			...
			<asp:DropDownList ID="DDLFTable" CssClass="form-control pull-left" Width="100" runat="server" AutoPostBack="True" OnSelectedIndexChanged="BindTableField">
			...
			<asp:DropDownList ID="DDLtj" CssClass=" form-control pull-left" Width="100" runat="server">
	  ...
	  <tr>
		...
		<td><div id="Div2" class="fielddiv">
			<asp:DropDownList ID="DDLOrderTable" CssClass="form-control" Width="100" runat="server" AutoPostBack="True" OnSelectedIndexChanged="BindOrderField">
			...
			<asp:DropDownList ID="DDLOrder" CssClass="form-control" Width="100" runat="server">
