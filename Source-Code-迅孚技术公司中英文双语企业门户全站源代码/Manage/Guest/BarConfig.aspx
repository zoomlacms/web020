<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Guest_BarConfig, App_Web_zcwm5tvr" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <td ng-app="app">
                    <div ng-controller="appController" class="text_500">
                        <table class="table table-bordered">
                            ...
                            <tr><td colspan="3"><div id="page_div"></div></td></tr>
                        </table>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script type="text/javascript">
        //1,一个分页JS对象,代表一个完成的,包括数据存储等,但并不使用,使用由页面完成
        ...
        var app = angular.module("app", []).controller("appController", function ($scope, $compile) {
            ...
            for (var i = 0; i < barids.length; i++) {
                ...
                PageHelper.DataSource.push({id:barids[i],username:barnames[i]});
            }
            PageHelper.Init({
                id: "page_div" , cpage: 1,psize:5,
                pagenum: PageHelper.GetPageNum(PageHelper.DataSource.length,5),
                click: function (param) {
                    curScope.$apply(function ($compile) {
                        $scope.list=PageHelper.GetPageDT();
                    });
                    PageHelper.Render();
                }
            });
            ...
            $scope.remove = function (id) {
                $scope.list.RemoveByID(id);
                PageHelper.DataSource.RemoveByID(id);
