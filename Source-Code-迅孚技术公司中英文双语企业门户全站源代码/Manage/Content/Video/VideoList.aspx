<%@ page language="C#" autoeventwireup="true" inherits="Manage_Content_Video_VideoList, App_Web_hyhk3ogg" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <a class="option_style" href="VideoInfo.aspx?id=<%#Eval("ID") %>"><i class="fa fa-edit" title="修改"></i></a>
                    <a class="option_style" href="VideoManage.aspx?id=<%#Eval("ID") %>"><i class="fa fa-magic" title="管理"></i></a>
