<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_ModelField, App_Web_lj4wdxm0" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <asp:Repeater ID="rptModelField" runat="server" OnItemCommand="rptModelField_ItemCommand">
                <ItemTemplate>
                    <tr ondblclick="location.href='AddModelField.aspx?FieldID=<%# Eval("FieldID") %>&ModelID=<%# Eval("ModelID") %>&ModelType=<%=Request["ModelType"] %>'">
                        ...
                        <td class="text-center"><%#IsValid(Eval("IsShow", "{0}")) %></td>
