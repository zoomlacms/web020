<%@ page language="C#" autoeventwireup="true" inherits="Manage_APP_AddJsonP, App_Web_wubgtu1t" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="tab-content">
        ...
        <tr>
            <td>主表名：</td>
            <td>
                <asp:TextBox runat="server" ID="T1_T" CssClass="form-control m715-50" /><span class="rd_green">主表别名为A</span>
        ...
        <tr>
            <td>次表名：</td>
            <td>
                <asp:TextBox runat="server" ID="T2_T" CssClass="form-control m715-50" /><span class="rd_green">次表别名为B</span></td>
        </tr>
        <tr>
            <td>主表主键：</td>
            <td>
        ...
        <div id="tabs1" class="tab-pane">
            <table class="table table-bordered table-striped">
                <tr><td class="td_m">SQL 语句：</td><td><asp:TextBox runat="server" ID="SQL_T" style="height:120px;" CssClass="form-control" TextMode="MultiLine" /></td></tr>
                <tr><td>异常信息：</td><td><asp:Label style="color:red;" runat="server" ID="Exception_L"></asp:Label></td></tr>
