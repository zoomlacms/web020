<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_Add_Papers_System, App_Web_gzlj2emr" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr class="tdbg">
            ...
            <td>
               <ZL:TreeTlp ID="Paper_Tree" Selected="PaperType_Hid" EmpyDataText="请选择试卷类型!" runat="server" />
                <asp:HiddenField ID="PaperType_Hid" runat="server" />
            </td>
        </tr>
        <tr>
