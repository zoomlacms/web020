<%@ page language="C#" autoeventwireup="true" inherits="User_Questions_ExamDetail, App_Web_rirx0pop" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="panel panel-primary">
        <div class="panel-heading"><i class="fa fa-file-text-o"></i>
            <span class="margin_l5"><asp:Label runat="server" ID="PName_L"></asp:Label>
            </span>
            ...
            <asp:Repeater runat="server" ID="MainRPT" EnableViewState="false" OnItemDataBound="MainRPT_ItemDataBound">
                <ItemTemplate>
                    <div  style="margin-top:5px;">
                        <%#Container.ItemIndex+1 +"．"+Eval("QName")+"（有"+Eval("QNum")+"小题,共"+Eval("TotalScore")+"分）" %>
                    </div>
        ...
        <div class="panel-footer text-center" >
             ...
             <a href="ExamDetail.aspx?ID=<%=Mid %>" class="btn btn-primary">返回</a>
        </div>
    </div>
<div>
</div>
