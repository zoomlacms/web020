<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Manage/I/Default.master" inherits="Manage_Exam_KnowledgeManage, App_Web_gzlj2emr" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <ZL:Repeater ID="RPT" runat="server" OnItemCommand="RPT_ItemCommand">
        <ItemTemplate>
            <tr data-layer="1" data-id='<%#Eval("k_id") %>'>
                ...
                <td><%#Eval("CDate") %></td>
                <td>
                    <a href='AddKnowledge.aspx?id=<%#Eval("k_id") %>' title='修改'><span class='glyphicon glyphicon-pencil option_style'></span></a>
