<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UserPurse, App_Web_dkew0mlg" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div id="UserPDiv" runat="server">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TxtScore" runat="server" Text="0" class="form-control text_300"/>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TxtDetail" runat="server" TextMode="MultiLine" CssClass="form-control text_300"></asp:TextBox>
                </td>
            </tr>
            <tr>
    ...
    <table runat="server" id="EditMoney" visible="false" class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="HisTime" class="form-control text_300" Style="max-width: 200px;" runat="server" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 20%" class="text-right">操作金额：</td>
            <td>
                <asp:TextBox ID="Score" class="form-control text_300" Style="max-width: 200px;" runat="server" Text="0"></asp:TextBox>
