<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Config_SiteOption, App_Web_hhsdimvv" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table table-striped table-bordered table-hover">
	<tbody>
        ...
        <tr>
            <td><strong>强制Https访问：</strong></td>
            <td>
               <input type="checkbox" runat="server" class="switchChk" id="safeDomain_Chk" />
               <span>提示:开启后,所有http访问会自动跳转至https(如未配置证书,请勿开启)</span>
            </td>
        </tr>
		<tr>
